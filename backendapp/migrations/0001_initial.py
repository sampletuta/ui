# Generated by Django 4.2.23 on 2025-09-24 02:57
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "person_name",
                    models.CharField(
                        help_text="Name of the authorized person", max_length=100
                    ),
                ),
                (
                    "employee_id",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Additional notes about the person",
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="Access valid from this date", null=True
                    ),
                ),
                (
                    "valid_until",
                    models.DateTimeField(
                        blank=True, help_text="Access expires on this date", null=True
                    ),
                ),
                (
                    "clearance_level",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=list,
                        help_text="List of authorized areas/zones",
                    ),
                ),
                (
                    "last_verified",
                    models.DateTimeField(
                        blank=True, help_text="Last time access was verified", null=True
                    ),
                ),
                (
                    "approved_by",
                    models.ForeignKey(
                        ...
                        related_name="whitelist_approved",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="whitelist_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="images",
                        to="backendapp.targets_whitelist",
                    ),
                ),
                (
                    "uploaded_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_duplicate",
                    models.BooleanField(
                        default=False, help_text="Whether this detection is a duplicate"
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Reason for deduplication: temporal, spatial, confidence, rate_limit",
                        max_length=50,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether an alert was created for this detection",
                    ),
                ),
                (
                    "alert_created_at",
                    models.DateTimeField(
                        blank=True, help_text="When the alert was created", null=True
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="External detection service ID",
                        max_length=100,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="internal",
                        help_text="Source of detection: internal, external, api",
                        max_length=50,
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        help_text="Original detection if this is a duplicate",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        to="backendapp.searchresult",
                    ),
                ),
                (
                    "search_query",
